...
void ExecutaComandos(char comando[]){

    if (comando[0] == 'I' && comando[1] == 'I'){ // Insere no inicio da lista

        char path[30];
        
        int j = 3;
        for (int i = 0; j < strlen(comando); i++,j++){
            path [i] = comando[j];
            path [i + 1] = '\0';
        }
    ...
    else if(comando[0] == 'I' && comando[1] == 'F'){ // Insere no inicio da final
    ...
    else if (comando[0] == 'I' && comando[1] == '*'){ // Insere na posição
        char path[30]; int j = 3; char posstr[10];
        
        for (int i = 0; comando[j] != ' '; i++,j++){
            posstr[i] = comando[j];
            posstr[i + 1] = '\0';
        }

        int posint = 0;
        sscanf(posstr,"%i",&posint);   
    ...
    else if(comando[0] == 'R' && comando[1] == 'I'){ // Remove no Inicio
        
        printf("%s\n",removerInicio());

    }
    else if(comando[0] == 'R' && comando[1] == 'F'){ // Remove no Final
    
        printf("%s\n",removerFim());
    }
    else if (comando[0] == 'R' && comando[1] == '*'){ // Remove na Posição
        
        int j = 3; char posstr[10];

        for (int i = 0; j < strlen(comando); i++){
            posstr[i] = comando[j];
            posstr[i + 1] = '\0'; 
            j++;
        }
