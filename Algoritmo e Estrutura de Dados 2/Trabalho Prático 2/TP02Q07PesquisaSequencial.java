...
class TP02Q07PesquisaSequencial {
    ...
    public static int PesquisaSequencial(Lista personagens, String nome){
        
        int comparacoes = 0;
        Personagem array[] = personagens.getArray();
        int n = personagens.getN();
    ...
    public static void main(String[] args) throws Exception {
        ...
        } while (isFim(entradaPesquisa[numEntradaPesquisa++]) == false);
        numEntradaPesquisa--; // Desconsiderar ultima linha contendo a palavra FIM
        ...
        // Para cada linha de entrada, pesquisa o nome do Personagem em questão
        for (int i = 0; i < numEntradaPesquisa; i++) {
            
            comparacoes += PesquisaSequencial(personagens,entradaPesquisa[i]);
        }

        long fim = System.currentTimeMillis();

        gravarArq.print("MATRICULA: 655310\tTEMPO DE EXECUCAO: " + ((fim-comeco)/1000.0) / numEntradaPesquisa + "s\t" + "COMPARACOES:" + comparacoes / numEntradaPesquisa);
