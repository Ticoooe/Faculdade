...
class TP04Q06HashComRehash{
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < numEntrada; i++) {
            ...
            boolean resp = hash.inserir(CriaPersonagem(entrada[i]));
            // if (resp==true){
            //     System.out.println("INSERI o " + entrada[i]);
            // } else System.out.println("NAO INSERI o " + entrada[i]);
        }
