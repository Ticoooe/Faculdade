...
class FilaCircular {
	 ...
	 * @param p (Personagem) elemento a inserir.
	 */
	public void inserir(Personagem p) {
        ...
        SomaAltura = SomaAltura + p.getAltura();
        quant++;

        MyIO.println((int)(Math.round((float)SomaAltura/quant)));
	...
	public String remover() throws Exception {
        ...
        quant--; 
        SomaAltura = SomaAltura - primeiro.getAltura(); 
	...
	public void mostrar() {
        ...
        int j=0;
		for(Personagem i = primeiro.prox; i != null; i = i.prox,j++) {
            System.out.print("[" + j + "] ");
            i.Imprime();
		}
 ...
 */
class TP03Q03FilaCircularFlexivel {

    /**
     * Executa comandos da entrada
     * @param s           (String) com comando dado pela entrada
     * @param personagens (FilaCircular) valor da memoria que aponta para a fila de personagens
     */
    public static void ExecutaComandos(String s, FilaCircular personagens) {
        ...
        if (s.charAt(0) == 'I') { // comando Inserir
            ...
            MyIO.println("(R) " + personagens.remover());
        } 
        }catch (Exception e){
    ...
    */
    ...
    public static void main (String[] args) throws IOException{
        ...
        int numEntrada = 0;
        FilaCircular personagens = new FilaCircular();
